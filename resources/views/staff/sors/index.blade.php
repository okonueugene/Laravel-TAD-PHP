        ...
        @if (empty(request()->type_param))
            <div class="add-button">
                <a href="#" class="btn btn-primary btn-sm  float-end mx-2 modal-button"
                    data-href="{{ url('/app/sors/create') }}">Add</a>
            </div>
        @else
            <div class="add-button">
                <a href="#" class="btn btn-primary btn-sm  float-end mx-2 modal-button"
                    data-href="{{ url('/app/sors/create') }}?type_param={{request()->type_param}}">Add</a>
            </div>
        @endif
...
@section('javascript')
    <script>
        $(document).ready(function() {
            var url = "{{ url('/app/sors') }}?type_param={{ request()->type_param }}";
