    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        @if (auth()->user()->can('add_environment'))
            <div class="add-button ">
                <a href="{{ url('/app/environmental-policy-checklist') }}" class="btn btn-primary btn-sm float-end mx-2">Add Policy
                    Checklist</a>
                <a href="#" class="btn btn-primary btn-sm  float-end mx-2 modal-button"
                    data-href="{{ url('/app/environment/create') }}">Add
                    Free
                    Form</a>
            </div>
        @endif
