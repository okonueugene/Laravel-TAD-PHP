    ...
    <div class="container-lg flex-grow-1 container-p-y">
        @if (auth()->user()->can('add_supervisor'))
            <div class="add-button">
                <a href="#" class="btn btn-primary btn-sm float-end modal-button" data-href="{{url('app/company/create')}}">Add
                    Company</a>
            </div>
        @endif
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> </span>Company’s Details</h4>
