    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                @if ($environment->comments !== null)
                    <textarea class="form-control" id="basic-default-comment" rows="4" readonly>{{ $environment->comments }}</textarea>
                @else
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="basic-default-status" value="{{ ucwords($environment->status) }}"
                    readonly>
            </div>
            <div class="mb-3">
