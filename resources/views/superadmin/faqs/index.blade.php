            ...
            <div class="col-lg-3 col-md-4 col-12 mb-md-0 mb-3">
                <div class="d-flex justify-content-between flex-column mb-2 mb-md-0">
                    <ul class="nav nav-align-left nav-pills flex-column" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#delivery" aria-selected="false"
                                tabindex="-1" role="tab">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#product" aria-selected="false"
                                tabindex="-1" role="tab">
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionPayment-1" class="accordion-collapse collapse show">
                                    <div class="accordion-body">
                                        ...
                                        order number that appears on the confirmation screen indicates payment has been
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionPayment-2" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        ...
                                        encrypt all information submitted to them, so you can be confident that your
                            ...
                            <div class="card accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Q4: Which license do I need for an end product that is only accessible to paying
                                        users?
                                    </button>
                                </h2>
                                <div id="accordionPayment-4" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        ...
                                        an Extended License. For each products, you need a license. You can get free
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionPayment-5" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        ...
                                        jujubes jujubes powder topping. Jelly beans gummi bears sweet roll bonbon muffin
                                        liquorice. Wafer lollipop sesame snaps.
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionDelivery-1" class="accordion-collapse collapse show">
                                    <div class="accordion-body">
                                        ...
                                        offering you the “room of choice” scheduled delivery service. For small
                                        products, we offer free parcel delivery.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionDelivery-2" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        ...
                                        destination postal code. The parcel delivery is free.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionCancellation-2" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        ...
                                        <a href="javascript:void(0);">support team</a>, All merchandise returned must
                                        be in the original packaging with all original items.
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="accordionOrders-1" class="accordion-collapse collapse show">
                                    <div class="accordion-body">
                                        <p>
                                            ...
                                            once the order has been processed. If you have not received your order
                                            confirmation email within 24 hours, check your junk email or spam folder.
                                        </p>
                                        <p class="mb-0">
                                            Alternatively, log in to your account to check your order summary. If you do
                                            not have a account, you can contact our Customer Care Team on
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionProduct-1" class="accordion-collapse collapse show">
                                    <div class="accordion-body">
                                        ...
                                        contain tracking and order information.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionProduct-2" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        ...
                                        warranty services, visit our Warranty section <a
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionProduct-3" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        ...
                                        year(s) of protection to the standard manufacturer’s warranty provided by us. To
                                        purchase or find out more about the extended warranty program, visit Extended
                                        Warranty section
